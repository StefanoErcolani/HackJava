...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //Inserire come parametro Object non funge perchè la dichiarazione di type parameter è generica, quindi si può effettuare direttamente la dichiarazione di un parametro.
        System.out.println(average(therms, (Thermometer obj) -> obj.getTherm() )); 

        System.out.println(average(sensors, (Sensor obj) -> obj.getTempsens() ));

        System.out.println(average(fridges, (FridgeTemp obj) -> obj.getFridgeTemp() ));
    }


    public static <T> double average(List<T> list, GenericGetTemperature<T> tGetter){
        ...
        for(T el : list){
            ...
            sum += tGetter.getGenTemperature(el);
